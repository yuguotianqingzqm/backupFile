	...
	<body>
		...
		<section>
			<div id="top">
				...
				<div id="div1">
<%--					<c:forEach items="${foods}" var="foods" varStatus="f">--%>
<%--						<c:if test="${s.index=={f.index}}">--%>
<%--							<ul id="img"><img src="${pageContext.request.contextPath}/upload/${foods.foodImage}" alt=""></ul>--%>
<%--						</c:if>--%>
<%--					</c:forEach>--%>
					<ul id="img"><img src="${pageContext.request.contextPath}/upload/${foods[s.index].foodImage}" alt=""></ul>
					<ul>
						<li>下单时间:<span>${orderDetail.createTime}</span></li>
						<li>总价:<span>${orderDetail.price}</span></li>
					</ul>
